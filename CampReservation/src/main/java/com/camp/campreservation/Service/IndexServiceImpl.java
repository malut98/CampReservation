...
public class IndexServiceImpl implements IndexService {
	...
	@Override
	public List<CampDBDto> serchList(Model model, String pagenum, String contentnum, String keyword) {
		...
		System.out.println(indexMapper.countArticle(keyword));
		...
		return indexMapper.serchList(keyword, pagemaker.getPagenum()*6,pagemaker.getContentnum());
	}
