...
%>
	...
	<div class="body">
	 ...
	 <input type="hidden" name="mar_num" value="${dto.mar_num}">
	 	...
	 	<span>제목</span> <input type="text" name="mar_title" id="ut"  value="${dto.mar_title }"><br>
	 	...
	 	<span>가격</span> <input type="number" name="mar_price" id="up"  value="${dto.mar_price }"><br>
	 	<span>설명</span> <textarea rows="10" cols="50" name="mar_content" id="uc"  >${dto.mar_content }</textarea>
